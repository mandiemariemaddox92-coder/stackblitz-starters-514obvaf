...
export function HeartIcon({ className, filled }: { className?: string, filled?: boolean }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill={filled ? "currentColor" : "none"} xmlns="http://www.w3.org/2000/svg">
      <path 
        d="M20.84 4.61C20.3292 4.09924 19.7228 3.69395 19.0554 3.4172C18.3879 3.14045 17.6725 2.99789 16.95 2.99789C16.2275 2.99789 15.5121 3.14045 14.8446 3.4172C14.1772 3.69395 13.5708 4.09924 13.06 4.61L12 5.67L10.94 4.61C9.9083 3.57831 8.50903 2.99839 7.05 2.99839C5.59096 2.99839 4.19169 3.57831 3.16 4.61C2.1283 5.64169 1.54839 7.04097 1.54839 8.5C1.54839 9.95903 2.1283 11.3583 3.16 12.39L4.22 13.45L12 21.23L19.78 13.45L20.84 12.39C21.3508 11.8792 21.756 11.2728 22.0328 10.6054C22.3096 9.93789 22.4521 9.22248 22.4521 8.5C22.4521 7.77752 22.3096 7.06211 22.0328 6.39463C21.756 5.72715 21.3508 5.12076 20.84 4.61Z" 
        stroke="currentColor" 
        strokeWidth="2" 
        strokeLinecap="round" 
        strokeLinejoin="round"
...
export function FeatherIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path 
        d="M20.24 12.24C21.3658 11.1142 21.9983 9.58722 21.9983 7.99499C21.9983 6.40277 21.3658 4.87578 20.24 3.75C19.1142 2.62422 17.5872 1.9917 15.995 1.9917C14.4028 1.9917 12.8758 2.62422 11.75 3.75L5 10.5V19H13.5L20.24 12.24Z" 
        stroke="currentColor" 
        strokeWidth="2" 
        strokeLinecap="round" 
        strokeLinejoin="round"
...
export function PawIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <ellipse cx="12" cy="17" rx="5" ry="4" stroke="currentColor" strokeWidth="2"/>
      <circle cx="6" cy="10" r="2" stroke="currentColor" strokeWidth="2"/>
...
export function VolumeIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <polygon points="11,5 6,9 2,9 2,15 6,15 11,19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
